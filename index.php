	...
	<body>
		<div class="container">
			...
			<header class="codrops-header">
				<h1>PTCL Data Center <span>The only TIER III Data Center facility in Pakistan</span></h1>
				<p>Kindly login in to your respective domain</p>
			</header>
			<section class="demo-1">
				<div class="grid">
					...
					<div class="box">
						...
						<h3>C</h3>
						<span>Corporate Office Login</span>
			...
			<section class="related">
				<h3>This website is a property of PTCL</h3>

...
.btn-register:focus {
    ...
    <?php 
    	...
    	if($_SERVER["REQUEST_METHOD"] == "POST"){
	    	...
	    	$sql = "SELECT ID, username, password, name FROM corporatelogin"; //query
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<form id="register-form"  method="post" role="form" style="display: none;">
									...
									<div class="form-group">
										<input type="text" name="company" id="company" tabindex="1" class="form-control" placeholder="Company" value="" required>
									</div>
									<div class="form-group">
										<select name="DataCenter" tabindex="1" class="form-control" value="" style="height:45px" required>
										<option  value="" disabled selected>Select DataCenter</option>
											<option value="volvo">Islamabad(IT)</option>
											<option value="saab">Karachi(IT)</option>
											<option value="fiat">Lahore(Commercial)</option>
											<option value="audi">Karachi(Commercial)</option>
									</select>
									</div>
									<div class="form-group">
